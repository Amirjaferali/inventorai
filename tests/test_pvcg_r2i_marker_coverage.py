...
# Wave-1 RVR-2 re-declaration (WAVE_1_REMEDIATION_IMPLEMENTATION_CONTRACTS.md):
# the marker families were re-derived from the COMMITTED Path-N question banks
# under the R2 contract's own derivation rule. This inventory is regenerated to
# match — the harness's designed explicit re-declaration act for any family
# change; every probe below still passes unchanged, so the disjointness and
# threshold architecture is preserved.
DECLARED_WORDS = {
    "ASSUMPTION_INVENTORY": (
        "assume", "assumed", "assumes", "assuming", "assumption",
        "assumptions", "believe", "believed", "expect", "expected",
        "expects", "granted", "hypotheses", "hypothesis", "presume",
        "presumed", "presumes", "unconfirmed", "unproven", "untested",
        "unverified",
    ),
    "BOUNDARY_AMBIGUITY": (
        ...
        "excludes", "excluding", "existing", "handles", "handling",
        "irreplaceable", "job", "limitation", "limitations", "outside",
        "prior", "replace", "replaceable", "replaced", "replacing",
        "responsibilities", "responsibility", "responsible", "restricted",
        "restricts", "scope", "similar", "uncovered", "unlike", "versus",
        "vs", "whereas",
    ),
    "EXPERTISE_GAP_AWARENESS": (
        "background", "competence", "competency", "consult", "consultant",
        "discipline", "disciplines", "engineer", "engineering",
        "engineers", "experience", "experienced", "expert", "expertise",
        "experts", "familiar", "hire", "knowledge", "learn", "learning",
        "mentor", "professional", "qualified", "skill", "skills",
        "specialist", "specialists", "trained", "training", "unfamiliar",
    ),
    "MECHANISM_COMPLETENESS": (
        "activate", "activates", "actuate", "actuates", "amplifies",
        "amplify", "close", "closes", "compare", "compares", "component",
        "components", "compute", "computes", "connect", "connects",
        "convert", "converts", "detect", "detects", "disconnect",
        "disconnects", "drive", "drives", "filters", "latch", "latches",
        "measure", "measures", "module", "modules", "motion", "move",
        "moves", "notice", "noticed", "notices", "open", "opens", "part",
        "parts", "procedure", "process", "receive", "receives", "respond",
        "responds", "rotate", "rotates", "send", "sends", "sense",
        "senses", "sequence", "stage", "stages", "step", "steps",
        "subsystem", "subsystems", "switch", "switches", "transfer",
        "transfers", "transmit", "transmits", "trigger", "triggers",
    ),
    "PHYSICAL_FEASIBILITY": (
        ...
        "joule", "joules", "khz", "magnetic", "material", "materials",
        "mhz", "milliamp", "milliamps", "milliwatt", "milliwatts",
        "optical", "physically", "physics", "principle", "principles",
        "rated", "rating", "reliability", "reliable", "reliably",
        "resistive", "safe", "safely", "safety", "supply", "temperature",
        "thermal", "tolerance", "tolerances", "water", "watt", "watts",
        "wear", "wears", "withstand",
    ),
    "PROBLEM_MECHANISM_FIT": (
        "addresses", "condition", "conditions", "customer", "customers",
        "issue", "issues", "matters", "pain", "people", "person",
        "problem", "problems", "scenario", "scenarios", "situation",
        "situations", "solve", "solved", "solves", "solving", "struggle",
        "struggles", "suffer", "suffers", "suitable", "suited",
        "unsuitable", "user", "users",
    ),
}
