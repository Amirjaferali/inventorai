...
authority-at-that-time). **`RVR-6A CLOSED: NO`** — implementation authority is not formal
closure; the closure lifecycle is the next eligible gate (no obligation blocks it — see the
Deferred Obligations Register RVR-6a row). `W2-C / RVR-6b / RVR-7 / RVR-8: NOT AUTHORIZED`;
