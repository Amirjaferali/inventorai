...
**`RVR-7 NEXT ELIGIBLE GATE — REQUIRES SEPARATE OWNER AUTHORIZATION`** — eligibility is not
authorization, no RVR-7 contract exists, and none is created by this record:
