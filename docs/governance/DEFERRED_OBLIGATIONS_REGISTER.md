...
the post-W2-B-implementation synchronization (base
`ac9c01ea1caaca18306a99039cea3a4224216e8a`, PR #576 — the authoritative
W2-B/RVR-6a implementation merge under Contract Amendment 1; prior
maintenance gate: the post-W2-B-contract synchronization, PR #573).
