...
the RVR-6a formal-closure gate (base
`eb23cbf2b1b3b4d81908942ea9231756c90d8d94`, PR #577 — the authoritative
post-W2-B-implementation sync merge; prior maintenance gates: the
post-W2-B-implementation synchronization at the PR #576 base, and the
post-W2-B-contract synchronization, PR #573).
